...
import { Tasks, List, AddButtonList} from './components';
    ...
    <div className="todo">
      ...
      <div className="todo__tasks">
        <Route exact path="/">
          {lists &&
            lists.map(list => (
              <Tasks key={list.id} list={list} onAddTask={onAddTask} onRemoveTask={onRemoveTask} onCompleteTask={onCompleteTask} onEditTitle={onEditListTitle} withoutEmpty/>
            ))
          }
        </Route>
        <Route path="/lists/:id">
          {lists && activeItem && ( <Tasks list={activeItem} onAddTask={onAddTask} onRemoveTask={onRemoveTask} onEditTask={onEditTask} onCompleteTask={onCompleteTask} onEditTitle={onEditListTitle} /> )}
        </Route>
      </div>
    </div>
  );
